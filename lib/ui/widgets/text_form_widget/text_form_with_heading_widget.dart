...
class TextFormWithHeadingWidth extends StatefulWidget {
  ...
  const TextFormWithHeadingWidth({
    this.labelText,
  ...
  @override
  State<TextFormWithHeadingWidth> createState() => _TextFormWithHeadingWidthState();
}

class _TextFormWithHeadingWidthState extends State<TextFormWithHeadingWidth> {
  @override
  void initState() {
    super.initState();
  }
