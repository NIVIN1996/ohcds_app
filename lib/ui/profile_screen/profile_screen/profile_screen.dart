...
import '../../widgets/app_bar_widget/custom_app_bar_widget.dart';
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            top: context.heightPx * 50.0, left: context.widthPx * 24, right: context.widthPx * 24),
                      ...
                      Padding(
                        padding: EdgeInsets.only(top: context.heightPx * 100.0),
                        child: Align(
            ...
            Positioned(
              child: Padding(
                padding: EdgeInsets.only(top: context.heightPx * 85.0),
                child: Align(
            ...
            Positioned(
              child: Padding(
                padding: EdgeInsets.only(top: context.heightPx * 220.0),
                child: Align(
                  alignment: Alignment.topCenter,
                  child: Column(
                    children: [
